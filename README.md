...
This project use prompt engineering techniques with Chat GPT
...
Top 5 products from 3 brands :

* Top 5 running watch from *Garmin*
* Top 3 TVs from *LG*
* Top 5 smartphone from *Samsung*
...
## Ehancing the project

**Some ideas to improve the project further:**

* Improving the detection of pdf title (E.g : scanning first page to detect title).
* *Cloudify* the project: build a dockerfile, build a CI/CD pipeline, deploy to Azure/GCP/AWS.
* Building a logging/account system.
